...
public class QT_RenderBaseMap : MonoBehaviour {
	...
	{       
		...
		else
		{
           ...
           // Debug.Log("Texstart: " + texStart);          
            ...
            RevertScene(fog, ambient, terrainObject, terrainOffset, Lights);
            yield break;
            }
    ...
    private void RevertScene(bool fog, Color ambient,Terrain terrainObject,float terrainOffset, Light[] Lights)
    {
