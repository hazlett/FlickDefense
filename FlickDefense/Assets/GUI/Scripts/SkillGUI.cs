    ...
    private void LightningSkill()
    {
        ...
        switch (UserStatus.Instance.LightningLevel)
        {
            case 0: if (GUI.Button(new Rect(scaledResolutionWidth * 4 / 16 - skillBlock.x / 2, nativeVerticalResolution * 1.5f / 7 - skillBlock.y / 2, 
                ...
                {
                    skillWindow = true;
                    SetSkillInfo(250, "Strike down 1 enemy with a powerful lightning spell.  Kills any enemy (aside from bosses) on contact. ", "Lightning Strike", "Lightning");
                }
                break;
            case 1:
                ...
                {
                    skillWindow = true;
                    SetSkillInfo(500, "Strike down up to 4 enemies with this more powerful spell. Lighting will chain from one enemy to another.", "Chain Strike 1", "Lightning");
                }
                break;
            case 2:
                ...
                {
                    skillWindow = true;
                    SetSkillInfo(750, "Strike down up to 7 enemies with this more powerful spell. Lighting will chain from one enemy to another.", "Chain Strike 2", "Lightning");
                }
                break;
            case 3:
                ...
                {
                    skillWindow = true;
                    SetSkillInfo(1000, "Strike down up to 10 enemies with this more powerful spell. Lighting will chain from one enemy to another.", "Chain Strike 3", "Lightning");
                }
                break;
            case 4:
                ...
                {
                    skillWindow = true;
                    SetSkillInfo(1500, "Summon a powerful storm of lighting that will shock enemies all over the map for a short amount of time.", "Lightning Storm", "Lightning");
                }
                break;
            default:
                break;
    ...
    private void FireSkill()
    {
        ...
        switch (UserStatus.Instance.FireLevel)
        {
            case 0: if (GUI.Button(new Rect(scaledResolutionWidth * 4 / 16 - skillBlock.x / 2, nativeVerticalResolution * 3 / 7 - skillBlock.y / 2, skillBlock.x, skillBlock.y), fireTexture[0], "BlankButton"))
                {
                    skillWindow = true;
                    SetSkillInfo(250, "Unleash a fireball that will engulf your foe and burn them over time. ", "Fireball", "Fire");
                }
                break;
            case 1:
                ...
                {
                    skillWindow = true;
                    SetSkillInfo(500, "The fireball will now damage surrounding enemies (Up to 3) and damage them over time. ", "Fire Blast", "Fire");
                }
                break;
            case 2:
                ...
                {
                    skillWindow = true;
                    SetSkillInfo(750, "All enemies who try to pass through the fire storm will be burned, damaging them over time.", "Fire Storm", "Fire");
                }
                break;
            case 3:
                ...
                {
                    skillWindow = true;
                    SetSkillInfo(1000, "A wall of fire will be summoned in the path of your foes, damaging any that attempt to pass through.", "Fire Wall", "Fire");
                }
                break;
            case 4:
                ...
                {
                    skillWindow = true;
                    SetSkillInfo(1500, "Open up the sky and rain fire down upon all foes for a short period of time.", "Rain of Fire", "Fire");
                }
                break;
            default:
                break;
    ...
    private void IceSkill()
    {
        ...
        switch (UserStatus.Instance.IceLevel)
        {
            case 0: if (GUI.Button(new Rect(scaledResolutionWidth * 4 / 16 - skillBlock.x / 2, nativeVerticalResolution * 4.5f / 7 - skillBlock.y / 2, skillBlock.x, skillBlock.y), iceTexture[0], "BlankButton"))
                {
                    skillWindow = true;
                    SetSkillInfo(250, "Slows down 1 enemy for a short amount of time. ", "Iceball", "Ice");
                }
                break;
            case 1:
                ...
                {
                    skillWindow = true;
                    SetSkillInfo(500, "Slows down up to 3 enemies for a short amount of time. ", "Ice Blast", "Ice");
                }
                break;
            case 2:
                ...
                {
                    skillWindow = true;
                    SetSkillInfo(750, "Slows down enemies that it hits for a short amount of time ", "Ice Explosion", "Ice");
                }
                break;
            case 3:
                ...
                {
                    skillWindow = true;
                    SetSkillInfo(1000, "Slows down all enemies who pass through a set area for a short amount of time.  Helpful to hold back a lot of enemies. ", "Ice Storm", "Ice");
                }
                break;
            case 4:
                ...
                {
                    skillWindow = true;
                    SetSkillInfo(1500, "Slows down all of the enemies on screen for a short amount of time.  Very useful when you're being overwhelmed.", "Blizzard", "Ice");
                }
                break;
            default:
                break;
